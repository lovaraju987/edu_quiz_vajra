...
export default function HomeClient() {
    ...
    // ✅ Simple fetch — server already caches this with withCache() (5 min TTL)
    // No useQuery needed: the API returns in <5ms from memory cache
    ...
    // Recalculate exam status whenever settings data arrives or changes
    useEffect(() => {
        calculateStatus(settings);
        const interval = setInterval(() => calculateStatus(settings), 60000);
                                ...
                                <div className="w-full max-w-full lg:max-w-5xl mb-1 mt-2 relative z-50 px-1 lg:px-0">
                                    <div className="grid grid-cols-3 gap-1.5 sm:gap-2 w-full">
                                        <div className="flex flex-col items-center justify-center bg-sky-100/95 backdrop-blur-sm border-2 border-sky-400 rounded-lg py-1 px-1 shadow-sm transition-transform hover:scale-[1.01]">
                                            <span className="text-sky-800 font-black text-[9px] sm:text-[10px] lg:text-xs uppercase tracking-tight whitespace-nowrap">Age Group 1:</span>
                                            <span className="text-sky-950 font-bold text-[8px] sm:text-[9px] lg:text-[11px] leading-none mt-0.5 text-center whitespace-nowrap">4th, 5th &amp; 6th Classes</span>
                                        </div>
                                        <div className="flex flex-col items-center justify-center bg-violet-100/95 backdrop-blur-sm border-2 border-violet-400 rounded-lg py-1 px-1 shadow-sm transition-transform hover:scale-[1.01]">
                                            <span className="text-violet-800 font-black text-[9px] sm:text-[10px] lg:text-xs uppercase tracking-tight whitespace-nowrap">Group 2:</span>
                                            <span className="text-violet-950 font-bold text-[8px] sm:text-[9px] lg:text-[11px] leading-none mt-0.5 text-center whitespace-nowrap">7th &amp; 8th Classes</span>
                                        </div>
                                        <div className="flex flex-col items-center justify-center bg-amber-100/95 backdrop-blur-sm border-2 border-amber-400 rounded-lg py-1 px-1 shadow-sm transition-transform hover:scale-[1.01]">
                                            <span className="text-amber-800 font-black text-[9px] sm:text-[10px] lg:text-xs uppercase tracking-tight whitespace-nowrap">Group 3:</span>
                                            <span className="text-amber-950 font-bold text-[8px] sm:text-[9px] lg:text-[11px] leading-none mt-0.5 text-center whitespace-nowrap">9th &amp; 10th Classes</span>
                                        </div>
                                    </div>
                                </div>
