...
function ResultsContent() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans">
            <div className="max-w-2xl w-full bg-white rounded-[50px] shadow-2xl p-12 border border-slate-100 text-center relative overflow-hidden">
                ...
                <p className="text-slate-400 font-bold uppercase tracking-[0.2em] text-xs mb-10">Academic Excellence Achievement</p>

                <div className="grid grid-cols-2 gap-8 mb-12">
                    <div className="bg-slate-50 p-8 rounded-[35px] border border-slate-100 italic">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Your Score</p>
                        <p className="text-5xl font-black text-[#e11d48]">{score} / {total}</p>
                    </div>
                    <div className="bg-[#002e5d] p-8 rounded-[35px] text-white italic">
                ...
                <div className="space-y-4">
                    <p className="text-slate-500 font-bold italic mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/" className="px-10 py-4 bg-[#002e5d] text-white font-black rounded-2xl shadow-lg hover:bg-[#003d7a] transition-all uppercase tracking-widest text-xs">
                            Finish & Exit
                        </Link>
                        <Link href="/winners" className="px-10 py-4 bg-white text-[#002e5d] border-2 border-[#002e5d] font-black rounded-2xl shadow-sm hover:bg-slate-50 transition-all uppercase tracking-widest text-xs">
                            View Leaderboard
                        </Link>
                    </div>
                </div>
