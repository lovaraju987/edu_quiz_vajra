...
export async function GET() {
    try {
        ...
        // Clear existing questions to avoid duplicates in this seed run
        ...
        const questions = [
            ...
            { text: "Which bird can separate water and milk according to mythology?", options: ["Swan (Hamsa)", "Peacock", "Crow", "Parrot"], answerIndex: 0, category: "Health", level: 1 }, // Note: This was in user's paper under a mixed section
            ...
            // Adding placeholders to ensure variety
        ...
        // Ensure we have at least 25 questions per level by duplicating or adding more if needed
        // In a real scenario, we'd have 100+ unique questions.

        await Question.insertMany(questions);

        return NextResponse.json({ message: `Successfully seeded ${questions.length} questions!` });
    } catch (error: any) {
