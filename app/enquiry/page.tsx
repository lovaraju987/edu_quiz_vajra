        ...
        <MainLayout>
            <div className="min-h-[60vh] flex items-center justify-center p-6">
                <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 border border-slate-100 text-center">
                    ...
                    <h1 className="text-3xl font-black text-slate-900 mb-4">Enquiry</h1>
                    <p className="text-slate-500 leading-relaxed mb-8">Have questions? Get in touch with our team for more information about the Edu Quiz program.</p>
                </div>
            </div>
        </MainLayout>
    );
